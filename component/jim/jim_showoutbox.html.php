...
<?php
  ...
  $k = 0;
		...
		<tr class="sectiontableentry<?php echo $k+1; ?>">
			...
			<td>
				<a href="<?php echo JURI::base();?>/index.php?option=com_jim&task=viewsent&id=<?php echo $row->id?>" /><?php echo $subject?></a>
			</td>
			<td>
				<?php echo JHTML::profileLink($row->who_id,$row->username);?>
			</td>
...
?>  
		<tr class="sectiontableheader" >
			<td colspan="5">
				<input type="submit" class='button' value="<?php echo _JIM_DELETE_SEL?>" onclick="document.jimform.task.value='leavemsgs';document.jimform.submit();">
		   </td>
		</tr>
...
?>
	...
	<input type="hidden" name="leaveme" value="1" />
</form>
